...
public class SQLTest2 {
	...
	public void testany2(){
		...
		print("testany2",
				SQLFactory.COUNT(
					SQLFactory.SQL()
					.append("select * from tablea ")
					.append("join tableb on a1=b1 and b2 between ? and ?","b21","b22") 
					.append(SQLFactory.WHERE()
							.and("where a1=?","a1")
							.test(StringUtils.isEmpty(a2) == false).and("a2=?",a2)
							.test(StringUtils.isEmpty(a3) == false).and("a3<>?",a2)
							)	
				) 
			);
		...
		print("testany2",
			...
			.append(SQLFactory.WHERE()
					.and("paydate between ? and  ?", "20150101","20150603")
					.test(true).and("cola = ?", "1")
					.test(false).and("colb = ?", "2")
					.test(true).and("colc = ?", "3")
					)
			.append("order by cola")
			.test(true).append(",colb")
			.test(false).append(",colc")
			.test(true).append(",cold")
			.valid()
			);
	  */				
...
args=[1, 2, 3, 4, 5, 6]
	...
	*/
	...
	public void testsqlWhereClause(){
		...
		print("",				
				WhereClause.Where().and(SQLFactory.IN("bb in %?", new Object[]{"a","b","b","b"}))			 
	...
	public void testsql(){
		...
		.test(true).append(WhereClause.Where().test(true).and(" t21=?","t21"))
		.append(" )")
		;
	...
	public void testwhere(){
		...
		*/
		...
		print("testwhere1",WhereClause.Where()
				.test(true).and(" attr1 = ?", "rattr1")
				.test(false).and("attr2 is not null")				
		);
		print("testwhere2",WhereClause.Where()
